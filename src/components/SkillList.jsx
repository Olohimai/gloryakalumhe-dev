...
function SkillList() {
  ...
  return (
    <div>
          <ul class="grid grid-cols-2 gap-x-4 gap-y-10 sm:grid-cols-3 sm:gap-x-6 lg:grid-cols-4 xl:gap-x-10 py-10">
              {files.map((file) => (
                  <li className='col-span-1 flex flex-col bg-white shadow-md'>
